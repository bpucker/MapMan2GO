...
The following script compute the F1-Scores and Matthews correlation coeficient of the three methods mentioned above on several levels:
...
```
Generate a text file containing the performance evaluation of the three methods, including and excluidng the ancestral GO terms, as well as incluidng and excluding those proteins with 100 percent sequence similarity with best Blast. This is done for all the proteins as well as for the three sub-ontologies.

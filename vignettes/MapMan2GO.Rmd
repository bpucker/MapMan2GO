...
The following R script performs a revision on the MapMan Bins - GOAs assignation, classifying the GO Terms, both, used and no used, as Trusted or Untrusted according to their Evidence Codes (ECO). Returns plots of this evaluation.
